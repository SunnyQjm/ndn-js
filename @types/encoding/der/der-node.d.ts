...
export class DerNode {
     ...
     */
    static getSequence(children: DerNode[], index: number): DerNode.DerSequence;
}

export namespace DerNode {
    /**
...
////////
    ...
    export class DerByteString extends DerNode {
        ...
        constructor(inputData: Buffer, nodeType: number);
    ...
    export class DerInteger extends DerNode {
        constructor(integer: number | Buffer);
    ...
    export class DerBitString extends DerNode {
        constructor(inputBuf: Buffer, paddingLen: number);
    }
     ...
     */
    export class DerSequence extends DerNode.DerStructure {
        constructor();
    }
    ...
    export class DerGeneralizedTime extends DerNode {
        constructor(msSince1970: number);
